...
*/
const alabama_IvoteBallotDB_Controller = require('../controllers/alabama_IvoteBallotDB_Controller');
...
router
    .post('/alabama_SignUp_01', alabama_IvoteBallotDB_Controller.createAlabamaIvoteballotDatabase);

router
    .get('/signup1', alabama_IvoteBallotDB_Controller.alabamaSignUp_01_PassportGet);

router
    .post('/signup1', alabama_IvoteBallotDB_Controller.alabamaSignUp_01_PassportPost);
