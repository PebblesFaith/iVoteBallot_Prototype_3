...
*/
const Sqlite3ContactUsSessionStore = require('better-sqlite3-session-store')(session);
...
*/
const db = new sqliteDB('contactUs_01_Session.db', { verbose: console.log('The contactUs_01_Session have been successfully created') });
...
router.use('/contactUs_01',
	session({
		store: new Sqlite3ContactUsSessionStore({
			client: db,
			dir:'contactUs_01_Database_Session.db',
			name:'SESSION_NAME',
			cookie: {
				secure: true,
				httpOnly: true,
