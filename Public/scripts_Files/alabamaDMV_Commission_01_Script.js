...
const validateAlabamaDMV_CommissionForm = (e) => {    
    ...
    const userDMV_StateSelection = document.getElementById('stateSelect').value.trim();
	...
	if (userDMV_SSN === '' || userDMV_SSN == null || !userDMV_SSN.match(regExSSN)) {                                                               
		document.getElementById('userDMV_SSNErrorMessage').innerHTML = 'The user SSN is a required input field or you must enter the user correct SSN into the require input field.';
	...
	if (userDMV_ConfirmEmail === '' || userDMV_ConfirmEmail == null || userDMV_ConfirmEmail.length <= 6 || !userDMV_ConfirmEmail.match(regExEmail)) {
		document.getElementById('userDMV_ConfirmEmailErrorMessage').textContent = 'The user\'s confirm email address is a required input field and you must enter the correct user confirm email address format into the require input field.';
	...
	if (userDMV_PhoneNumber === '' || userDMV_PhoneNumber == null || userDMV_PhoneNumber.length <= 10 || !userDMV_PhoneNumber.match(regExPhoneNumber))  {                                                               
		document.getElementById('userDMV_PhoneNumberErrorMessage').textContent = 'The user\'s phone number is a required input field or you must enter exactly the user twelve number digits into the phone number required input field.';
	...
	if (userDMV_UnitType === '' || userDMV_UnitType == null) {
		document.getElementById('userDMV_UnitTypeErrorMessage').textContent = 'Select the user residential unit type to which he or she lives in, and the user residential unit type is a require field.';
	...
	if (userDMV_UnitTypeNumber === '' || userDMV_UnitTypeNumber == null || userDMV_UnitTypeNumber.match(regExUnitTypeNumber))  {                                                               
		...
		document.getElementById('userDMV_UnitTypeNumberErrorMessage').textContent = 'Error Message: The user\'s address unit type number is a required field unless the user own his or her  home or other residential property which does not have an address unit type number. Please leave blank, if the user does not have an apartment number or unit number of an alphanumeric characters.';
    ...
    if (userDMV_StateSelection === '' || userDMV_StateSelection == null) {       
        document.getElementById('userDMV_StateSelectionErrorMessage').textContent = 'Error Message: The user\'s state is a required select option field and you must select the user correct state from the option require field.';

        setTimeout(function() {
            document.getElementById('userDMV_StateSelectionErrorMessage').textContent = '';
        },
        9000)    	
    ...
    if (userDMV_CountySelection === '' || userDMV_CountySelection == null) {
		document.getElementById('userDMV_CountySelectionErrorMessage').textContent = 'Error Message: The user\'s county is a required select option field and you must select the user correct county from the option require field.';

		setTimeout(function() {
			document.getElementById('userDMV_CountySelectionErrorMessage').textContent = '';
		},
		9000)    	
	...
	if (userDMV_CitySelection === '' || userDMV_CitySelection == null) {
		document.getElementById('userDMV_CitySelectionErrorMessage').textContent = 'Error Message: The user\'s city is a required select option field and you must select the user correct city from the option require field.';

		setTimeout(function() {
			document.getElementById('userDMV_CitySelectionErrorMessage').textContent = '';
		},
		9000)    	
	...
	if (userDMV_ZipSelection === '' || userDMV_ZipSelection == null) {
		document.getElementById('userDMV_ZipSelectionErrorMessage').textContent = 'Error Message: The user\'s zip code area is a required select option field and you must select the user correct zip code area from the option require field.';

		setTimeout(function() {
			document.getElementById('userDMV_ZipSelectionErrorMessage').textContent = '';
		},
		9000)    	
