...
document.getElementById("division").addEventListener("change", function() {
    ...
    if (division) {
        ...
        var departments = {
            ...
            'El-Emp': 'Election Assures Employee Department',
            'Ex-Emp': 'Executive Office Employee Office',
            'Ex-Off': 'Executive Officer Office',
			'Fi-Dir': 'Finance Director Department',
			'Fi-Emp': 'Finance Employee Department',
			'Fi-Mgr': 'Finance Manager Department',
			'HR-Dir': 'Human Resources Director Department',
			'HR-Emp': 'Human Resources Employee Department',
			'HR-Mgr': 'Human Resources Manager Department', 
			'IT-Dir': 'Information Technology Director Department',
			'IT-Emp': 'Information Technology Employee Department',
			'IT-Mgr': 'Information Technology Manager Department',  
			'MA-Dir': 'Marketing Director Department',
			'MA-Emp': 'Marketing Employee Department',
			'MA-Mgr': 'Marketing Manager Department',
			'OP-Dir': 'Operations Director Department',
			'OP-Emp': 'Operations Employee Department',
			'OP-Mgr': 'Operations Manager Department',
			'OP-Sr': 'Operation Senior Department',     
